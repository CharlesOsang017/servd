      ...
      <div className="max-w-6xl mx-auto">
        ...
        {recipeOfTheDay && (
          <section className="mb-12 relative">
            <div className="flex items-center gap-2 mb-6">
              ...
              <h2 className="text-3xl fnt-serif font-bold text-stone-900">
                Recipe of the Day
              </h2>
            </div>
            <Link
            ...
            >
              <div className="relative bg-white border-2 border-stone-900 overflow-hidden hover:border-orange-600 hover:shadow-lg transition-all duration-300 group cursor-p">
                <div className="grid md:grid-cols-2 gap-0">
                  ...
                  <div className="p-8 md:p-12 flex flex-col justify-center">
                    <div className="flex flex-wrap gap-2 mb-6">
                      ...
                      <Badge
                        variant="outline"
                        className="border-2 border-orange-900 text-stone-700 bg-stone-50 font-bold"
                      >
                    ...
                    <p className="text-stone-600 mb-6 line-clamb-3 font-light text-lg">
        ...
        <section className="mb-24">
          <div className="mb-8">
            ...
            <p className="text-stone-600 text-lg font-">
        ...
        <section className="mb-24">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4">
            {areas.map((area, index) => (
              <Link
                key={index}
                href={`/recipes/cuisines/${area.strArea.toLowerCase()}`}
              >
                <div className="bg-white p-6 border-2 border-stone-200 hover:border-orange-600 hover:shadow-lg transition-all text-center group cursor-pointer">
