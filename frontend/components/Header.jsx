...
const Header = async () => {
  ...
  return (
    <header className="fixed top-0 w-full border-b border-stone-200 bg-stone-50/50 backdrop-blur-md z-50 supports-backdrop-filter:bg-stone-50/60">
        ...
        <div className="flex items-center space-x-4">
          <Show when="signed-out">
            <SignInButton mode="modal">
              <Button
                variant="ghost"
                className="text-stone-600 cursor-pointer hover:text-orange-600 hover:bg-orange-50 font-medium"
              >
                Sign In
              </Button>
            </SignInButton>
